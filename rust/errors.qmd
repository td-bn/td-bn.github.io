...
[Playground example](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&gist=7eb17f3b3f9bff64322c13e2fd25909c) of error enumeration.
...
## Propagating Errors
Rust's `?` operator acts as a shorthand for _unwrap of return early_ when working with Errors.
...
> NOTE: The `?` operator is just syntax sugar for a trait tentatively called `Try`.
 See: https://doc.rust-lang.org/std/ops/trait.Try.html

See [playground example](https://play.rust-lang.org/?version=stable&mode=debug&edition=2021&gist=a5a156aa12e2958050f1577e8564d0f3)
